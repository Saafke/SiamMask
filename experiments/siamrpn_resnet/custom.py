...
class ResDown(MultiStageFeature):
    ...
    def __init__(self, pretrain=False):
        ...
        self.layers = [self.downsample, self.features.layer2, self.features
            .layer3]
        self.train_nums = [1, 3]
    ...
    def param_groups(self, start_lr, feature_mult=1):
        ...
        def _params(module, mult=1):
            """I am a function."""
            params = list(filter(lambda x: x.requires_grad, module.
                parameters()))
            if len(params):
...
class Custom(SiamRPN):
    ...
    def __init__(self, pretrain=False, **kwargs):
        ...
        self.rpn_model = UP(anchor_num=self.anchor_num, feature_in=256,
            feature_out=256)
